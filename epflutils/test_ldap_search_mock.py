...
@patch('epflutils.ldap_search.get_sciper')
...
@patch('epflutils.ldap_search.get_username')
...
@patch('epflutils.ldap_search.get_units')
...
@patch('epflutils.ldap_search.is_unit_exist')
...
@patch('epflutils.ldap_search.get_unit_name')
